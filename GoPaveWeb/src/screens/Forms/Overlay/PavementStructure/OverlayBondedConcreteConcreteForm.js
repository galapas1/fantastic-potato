...
class OverlayBondedConcreteConcreteForm extends Component {
    ...
    return (
      <div style={{display: "flex", alignItems: "center", flexDirection: "column", height: "100%", 
        ...
        <div style={{height: "100%", width: "100%"}}>
          ...
          <FlexuralOutputForm flexStrengthOutputForm={OVERLAY_BONDED_CONCRETE_CONCRETE_FORM} module={OVERLAY_UA_MODULE} {...this.props} />
...
OverlayBondedConcreteConcreteForm = reduxForm({
  form: OVERLAY_BONDED_CONCRETE_CONCRETE_FORM,
  validate,
  warn,
  touchOnChange: true,
...
})(OverlayBondedConcreteConcreteForm);
...
OverlayBondedConcreteConcreteForm = connect(
  state => {
    const selector = formValueSelector(OVERLAY_BONDED_CONCRETE_CONCRETE_FORM);
...
export default OverlayBondedConcreteConcreteForm;
