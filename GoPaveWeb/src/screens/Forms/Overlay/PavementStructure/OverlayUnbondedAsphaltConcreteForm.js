...
class OverlayUnbondedAsphaltConcreteForm extends Component {
    ...
    return (
      <div style={{display: "flex", alignItems: "center", flexDirection: "column", height: "100%", 
        ...
        <div style={{height: "100%", width: "100%"}}>
          ...
          <FlexuralOutputForm flexStrengthOutputForm={OVERLAY_UNBONDED_ASPHALT_CONCRETE_FORM} module={OVERLAY_UA_MODULE} {...this.props} />
...
OverlayUnbondedAsphaltConcreteForm = reduxForm({
  form: OVERLAY_UNBONDED_ASPHALT_CONCRETE_FORM,
  validate,
  warn,
...
})(OverlayUnbondedAsphaltConcreteForm);
...
OverlayUnbondedAsphaltConcreteForm = connect(
  state => {
    const selector = formValueSelector(OVERLAY_UNBONDED_ASPHALT_CONCRETE_FORM);
...
export default OverlayUnbondedAsphaltConcreteForm;
