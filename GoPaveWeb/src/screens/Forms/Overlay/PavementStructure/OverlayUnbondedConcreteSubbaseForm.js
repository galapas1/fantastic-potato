...
import { setCurrentProjectUnitType,
         showOverlayUnbondedConcreteUserDefinedCompositeKValueRadioButtonValue } from 'Actions';
...
const radioKButtonTooltipID = 'overlayUnbondedConcreteStructureRadioButton';

class OverlayUnbondedConcreteSubbaseForm extends Component {
  ...
  changeToUserDefinedOutput() {
    this.props.showOverlayUnbondedConcreteUserDefinedCompositeKValueRadioButtonValue(true);
  }
      ...
      <div style={{display: "flex", alignItems: "center", flexDirection: "column", height: "100%", 
        ...
        <div style={{height: "100%", width: "100%", paddingLeft: 20, paddingRight: 20, borderRight: '1px solid'}}>
         <div style={{width: "100%", display: "flex", flexDirection: "column"}}>
            <ConcreteSurfaceTableStructureLayersForm structureTableLayerValues={structureTableLayerValues} bondBreaker={true} existingConcrete={true} structureTableLayerForm={OVERLAY_UNBONDED_CONCRETE_SUBBASE_FORM} kValueOutputForm={OVERLAY_UNBONDED_CONCRETE_SUBBASE_FORM} dropdownLabel='Subbase Layers' module={OVERLAY_UA_MODULE} dropdownValues={this.dropdownValues.bind(this)} title='CONCRETE OVERLAY (UNBONDED)' {...this.props} />
...
OverlayUnbondedConcreteSubbaseForm = reduxForm({
  form: OVERLAY_UNBONDED_CONCRETE_SUBBASE_FORM,
  validate,
...
})(OverlayUnbondedConcreteSubbaseForm);
...
function mapStateToProps(state) {
    ...
    const showCompositeKValueRadioButton = state.currentProject.overlayFormValues.unbondedConcreteShowCompositeKValueRadioButton;
...
function mapDispatchToProps(dispatch) {
    return {
        showOverlayUnbondedConcreteUserDefinedCompositeKValueRadioButtonValue: (value) => {
            dispatch(showOverlayUnbondedConcreteUserDefinedCompositeKValueRadioButtonValue(value))
        },
...
OverlayUnbondedConcreteSubbaseForm = connect(
    mapStateToProps, mapDispatchToProps      
)(OverlayUnbondedConcreteSubbaseForm)

export default OverlayUnbondedConcreteSubbaseForm;
