...
class OverlayUnbondedConcreteSummaryForm extends Component {
        ...
        if (this.props[SUMMARY_FORM_TOGGLE] === SUMMARY_FORM_SENSITIVITY) {
            ...
            return (
                <div style={{ height: '100%' }}>
                    <div style={{ display: 'flex', width: '82%', justifyContent: 'space-between', fontSize: 12, fontWeight: 'bold', marginBottom: 10, marginTop: 10 }}>
                        ...
                        <div style={{ fontSize: 11 }}>{`TOTAL FATIGUE USED %: ${dowelOption === SUMMARY_FORM_DOWELED ? this.props.unbondedConcreteDoweledFatigueUsedValue : this.props.unbondedConcreteUndoweledFatigueUsedValue}`}</div>
                    </div>
            ...
            return (
                <div style={{ height: '100%' }}>
                    <div style={{ display: 'flex', width: '82%', justifyContent: 'space-between', fontSize: 12, fontWeight: 'bold', marginBottom: 10, marginTop: 10 }}>
                        <div style={{ fontSize: 11 }}>{`TRAFFIC SUMMARY DETAILS: ${this.props.trafficSummaryDropdownValue}`}</div>
                        <div style={{ fontSize: 11 }}>{`TOTAL EROSION USED %: ${dowelOption === SUMMARY_FORM_DOWELED ? this.props.unbondedConcreteDoweledErosionUsedValue : this.props.unbondedConcreteUndoweledErosionUsedValue}`}</div>
                    </div>
                    <div style={{ width: '85%', height: '75%', overflowY: 'auto', minWidth: 400 }}>
                        <table style={{ width: '97%' }}>
                            <tbody style={{ fontSize: 11, textAlign: 'center' }}>
    ...
    render() {
        ...
        let tooltipAndStylesForDowelslessThanSevenInches = {
            ...(parseFloat(this.props[JPCP_DOWELED_DESIGN_THICKNESS]) < 7 && { 'showTooltip': true, 'tooltipId': overlayJpcpSummaryTooltipID, 'toolTipMessage': overlayUnbondedConcreteJpcpSummaryTooltipMessage, customSpanStyle, customInputStyle })
        };
        return (
            <div className='summary-page' style={{ zIndex: 10, paddingTop: 10, display: 'flex', flex: '1 1 0%', flexDirection: 'column', justifyContent: 'space-between' }}>
                <div style={{ paddingLeft: 30, paddingTop: 10 }}>
                    <div style={{ paddingLeft: 30, display: 'flex', width: '500px', borderBottomLeftRadius: '10px', borderTopLeftRadius: '10px', borderBottomRightRadius: '10px', borderTopRightRadius: '10px', backgroundColor: 'whitesmoke', fontWeight: 'bold' }}>
                        ...
                        <div style={{ paddingRight: 10 }}><i className="fa fa-chevron-circle-right"></i></div>
                        <div onClick={browserHistory.goBack} data-tip={radioKButtonTooltipMessage} data-for={radioKButtonTooltipID} style={{ paddingLeft: 5, color: "#3299CC", textDecoration: 'underline', cursor: 'pointer', fontSize: 16 }}>Unbonded Concrete</div>
                    </div></div>
                    ...
                    <div style={{ width: '30%', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: 20 }}>
                        ...
                        <div className='form-group-div' style={{ width: '100%', marginBottom: 20 }}>
                            ...
                            <div ref='RecommendedDesignThickness' style={{ display: 'flex', width: '100%', justifyContent: 'space-between' }}>
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: 'inherit' }}>
                                    <div style={{ paddingBottom: 20, fontSize: 12 }}>Doweled</div>
                                    <ReactTooltip id={overlayJpcpSummaryTooltipID} multiline={true} place='right' type='warning' effect='solid' />
                ...
                <Popup type={UNBONDED_CONCRETE} jpcpSummaryThicknessOption={this.props[JPCP_SUMMARY_FORM_THICKNESS_TOGGLE]} popup={OVERLAY_SUMMARY_FORM_GRAPH_POPUP} />
            </div>
        );
    }
...
OverlayUnbondedConcreteSummaryForm = reduxForm({
    form: OVERLAY_UNBONDED_CONCRETE_SUMMARY_FORM,
    destroyOnUnmount: false,
    initialValues: {
        [SUMMARY_FORM_TOGGLE]: SUMMARY_FORM_SENSITIVITY,
        [JPCP_SUMMARY_FORM_THICKNESS_TOGGLE]: SUMMARY_FORM_DOWELED
    }
})(OverlayUnbondedConcreteSummaryForm);

function mapStateToProps(state, ownProps, context) {
    const selector = formValueSelector(OVERLAY_UNBONDED_CONCRETE_SUMMARY_FORM);
    ...
    const unbondedConcreteDoweledKValueGraphData = state.currentProject.overlayFormValues.unbondedConcreteDoweledKValueGraphData;
    const unbondedConcreteUndoweledKValueGraphData = state.currentProject.overlayFormValues.unbondedConcreteUndoweledKValueGraphData;
    const unbondedConcreteDoweledFlexuralStrengthGraphData = state.currentProject.overlayFormValues.unbondedConcreteDoweledFlexuralStrengthGraphData;
    const unbondedConcreteUndoweledFlexuralStrengthGraphData = state.currentProject.overlayFormValues.unbondedConcreteUndoweledFlexuralStrengthGraphData;
    const unbondedConcreteDoweledReliabilityGraphData = state.currentProject.overlayFormValues.unbondedConcreteDoweledReliabilityGraphData;
    const unbondedConcreteUndoweledReliabilityGraphData = state.currentProject.overlayFormValues.unbondedConcreteUndoweledReliabilityGraphData;
    const unbondedConcreteDoweledDesignLifeGraphData = state.currentProject.overlayFormValues.unbondedConcreteDoweledDesignLifeGraphData;
    const unbondedConcreteUndoweledDesignLifeGraphData = state.currentProject.overlayFormValues.unbondedConcreteUndoweledDesignLifeGraphData;
    const unbondedConcreteDoweledSlabsCrackedGraphData = state.currentProject.overlayFormValues.unbondedConcreteDoweledSlabsCrackedGraphData;
    const unbondedConcreteUndoweledSlabsCrackedGraphData = state.currentProject.overlayFormValues.unbondedConcreteUndoweledSlabsCrackedGraphData;

    const unbondedConcreteDoweledCrackingValues = state.currentProject.overlayFormValues.unbondedConcreteDoweledCrackingValues;
    const unbondedConcreteUndoweledCrackingValues = state.currentProject.overlayFormValues.unbondedConcreteUndoweledCrackingValues;
    const unbondedConcreteDoweledFaultingValues = state.currentProject.overlayFormValues.unbondedConcreteDoweledFaultingValues;
    const unbondedConcreteUndoweledFaultingValues = state.currentProject.overlayFormValues.unbondedConcreteUndoweledFaultingValues;

    const unbondedConcreteDoweledFatigueUsedValue = state.currentProject.overlayFormValues.unbondedConcreteDoweledFatigueUsedValue;
    const unbondedConcreteUndoweledFatigueUsedValue = state.currentProject.overlayFormValues.unbondedConcreteUndoweledFatigueUsedValue;
    const unbondedConcreteDoweledErosionUsedValue = state.currentProject.overlayFormValues.unbondedConcreteDoweledErosionUsedValue;
    const unbondedConcreteUndoweledErosionUsedValue = state.currentProject.overlayFormValues.unbondedConcreteUndoweledErosionUsedValue;
    ...
    const concreteSubgradeForm = getFormValues(OVERLAY_UNBONDED_CONCRETE_EXISTING_CONCRETE_FORM)(state);
    const concreteSubbaseForm = getFormValues(OVERLAY_UNBONDED_CONCRETE_SUBBASE_FORM)(state);
    const concreteConcreteForm = getFormValues(OVERLAY_UNBONDED_CONCRETE_CONCRETE_FORM)(state);
    ...
    return {
        ...
        unbondedConcreteDoweledKValueGraphData,
        unbondedConcreteUndoweledKValueGraphData,
        unbondedConcreteDoweledFlexuralStrengthGraphData,
        unbondedConcreteUndoweledFlexuralStrengthGraphData,
        unbondedConcreteDoweledReliabilityGraphData,
        unbondedConcreteUndoweledReliabilityGraphData,
        unbondedConcreteDoweledDesignLifeGraphData,
        unbondedConcreteUndoweledDesignLifeGraphData,
        jpcpSummaryFormThicknessToggle,
        unbondedConcreteDoweledCrackingValues,
        unbondedConcreteUndoweledCrackingValues,
        unbondedConcreteDoweledFaultingValues,
        unbondedConcreteUndoweledFaultingValues,
        trafficSummaryDropdownValue,
        unbondedConcreteDoweledFatigueUsedValue,
        unbondedConcreteUndoweledFatigueUsedValue,
        unbondedConcreteDoweledErosionUsedValue,
        unbondedConcreteUndoweledErosionUsedValue,
        unbondedConcreteDoweledSlabsCrackedGraphData,
        unbondedConcreteUndoweledSlabsCrackedGraphData,
        jpcpDoweledDesignThickness,
        unitType,
    };
}
        ...
        generatePdf: (summaryContext) => {
            ...
            let imgRefs = [{
                ...
                fields: [
                    ...
                    { type: 'text', text: 'UNBONDED CONCRETE ON CONCRETE OVERLAY', value: '', x: 200, y: 35, xPad: 70, lg: true },
                ...
                },
            {
                    ...
                    fields: [
                        { type: 'text', text: '',
                            value: 'Doweled' + '            ' + 'Undoweled' + '    ', x: 5, y: 5, xPad: 125, sm: true },
                ...
                },
            {
                ...
                fields: [
                    ...
                    { type: 'text', text: 'EXISTING CONCRETE',
                        value: '', x: 150, y: 200, xPad: 0 },
                    ...
                    { type: 'text', text: 'Effective Thickness:',
                        ...
                        getUnits('in', isMetric), x: 150, y: 240, xPad: 110, sm: true },
                    { type: 'text', text: 'SUBGRADE',
                        value: '', x: 315, y: 200, xPad: 0 },
...
OverlayUnbondedConcreteSummaryForm = connect(
    mapStateToProps, mapDispatchToProps
)(OverlayUnbondedConcreteSummaryForm)
export default OverlayUnbondedConcreteSummaryForm;
