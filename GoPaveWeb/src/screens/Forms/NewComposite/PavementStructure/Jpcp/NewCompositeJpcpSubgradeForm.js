...
class NewCompositeJpcpSubgradeForm extends Component {
   
  render() {
    return (
      <NewCompositeCommonJpcpSubgradeForm kvalueOutputForm={NEW_COMPOSITE_JPCP_STRUCTURE_FORM} mrsgOutputForm={NEW_COMPOSITE_JPCP_SUBGRADE_FORM}  module={NEW_COMPOSITE_JPCP_MODULE} {...this.props} />
    );
  }
}

NewCompositeJpcpSubgradeForm = reduxForm({
  form: NEW_COMPOSITE_JPCP_SUBGRADE_FORM,
  validate,
  warn,
...
})(NewCompositeJpcpSubgradeForm);

NewCompositeJpcpSubgradeForm = connect(
  state => {
    const subgradeSelector = formValueSelector(NEW_COMPOSITE_JPCP_SUBGRADE_FORM);
    ...
    const subgradeFormErrors = getFormSyncErrors(NEW_COMPOSITE_JPCP_SUBGRADE_FORM)(state);
    const structureFormErrors = getFormSyncErrors(NEW_COMPOSITE_JPCP_STRUCTURE_FORM)(state);
...
export default NewCompositeJpcpSubgradeForm;
