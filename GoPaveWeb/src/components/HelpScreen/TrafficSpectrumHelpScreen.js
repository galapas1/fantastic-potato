...
const TrafficSpectrumHelpScreen = (props) => 
    ...
    <div style={{display: 'flex', flexDirection: 'column', marginBottom: 10, border: '1px solid'}}>
      <div style={{display: 'flex', borderBottom: '1px solid', backgroundColor: 'rgb(50, 153, 204)'}}>
        ...
        <div style={{ width: '22%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}>
          <div style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
                                <div style={{ borderBottom: '1px solid', textAlign: 'center' }}> <span style={{ color: 'white' }}>Maximum Axles Loads (kips)</span></div>            <div style={{ display: 'flex' }}>
      ...
      <div style={{display: 'flex', borderBottom: '1px solid'}}>
        ...
        <div style={{width: '11%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid'}}> 22</div>
        <div style={{width: '11%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}> 36</div>
      </div>
      <div style={{display: 'flex', borderBottom: '1px solid'}}>
        ...
        <div style={{width: '11%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid'}}> 26</div>
        <div style={{width: '11%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>44</div>
      </div>
      <div style={{display: 'flex', borderBottom: '1px solid'}}>
        ...
        <div style={{width: '11%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid'}}> 30</div>
        <div style={{width: '11%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>52</div>
      </div>
      <div style={{display: 'flex'}}>
        ...
        <div style={{width: '11%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid'}}> 34</div>
        <div style={{width: '11%', display: 'flex', alignItems: 'center', justifyContent: 'center'}}> 60</div>
    </div>
    </div>
...
export default TrafficSpectrumHelpScreen;
