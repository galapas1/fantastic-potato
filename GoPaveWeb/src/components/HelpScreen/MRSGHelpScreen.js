   ...
   <div style={{marginTop: 20, marginRight: 20, marginLeft: 20}}>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', marginBottom: 10, border: '1px solid' }}>
                    <div style={{ display: 'flex', borderBottom: '1px solid', backgroundColor: 'rgb(50, 132, 204)'}}>
                        ...
                        <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}> <span style={{ color: 'white' }}>Resilient Modulus (psi)</span></div>
                        </div>
      ...
      <div style={{display: 'flex'}}>
        ...
        <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid', borderBottom: '1px solid'}}>32,000-39,000 </div>   
      </div>
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid' }}>
          ...
          <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}>22,000-32,000 </div>
      </div>
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid' }}>
          ...
          <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}>15,000-25,000 </div>
      </div>
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid' }}>
          ...
          <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}>12,000-18,000 </div>
      </div>
      ...
      <div style={{ display: 'flex' }}>
          ...
          <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}>25,000-39,000 </div>
      </div>
      ...
      <div style={{ display: 'flex' }}>
          ...
          <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}>9,000-15,000 </div>
      </div>
      ...
      <div style={{ display: 'flex' }}>
          ...
          <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid', borderBottom: '1px solid' }}>5,000-8,000 </div>
      </div>
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid' }}>
          ...
          <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}>6,000-12,000 </div>
      </div>
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid' }}>
          ...
          <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}>5,000-8,000 </div>
      </div>
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid' }}>
          ...
          <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}>5,000-12,000 </div>
      </div>
      ...
      <div style={{ display: 'flex', borderBottom: '1px solid' }}>
          ...
          <div style={{ width: '20%', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRight: '1px solid' }}>4,000-6,000 </div>
      </div>
